...
from vmax.agents.learning.reinforcement import td3
...
def train(
    ...
    Args:
        trajectory_size: When > 0, the actor outputs a flat trajectory of this
            size (e.g. 16*2=32) and JAX LQR converts it to 2-dim control.
            Replay buffer and critic always use the 2-dim control action.
    """
    print(" TD3 ".center(40, "="))
    ...
    network, training_state, policy_fn = td3.initialize(
        action_size,
        observation_size,
        env,
        learning_rate,
    ...
    learning_fn = td3.make_sgd_step(
        network, discount, tau, policy_freq, noise_std, noise_clip,
        trajectory_size=trajectory_size,
    )
